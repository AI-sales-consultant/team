...
export function StreamliningClimbQuestions({ answers, onAnswer, scrollToNextQuestion }: StreamliningClimbQuestionsProps) {
  ...
  const handleOptionSelect = (questionId: string, option: string) => {
    ...
    if (currentIndex < streamliningClimbQuestions.length - 1) {
      ...
      setTimeout(() => {
        ...
        scrollToNextQuestion(questionId, streamliningClimbQuestions)
  ...
  return (
    <div className="space-y-6">
      {streamliningClimbQuestions.map((question) => {
                  ...
                  {question.additionalInfo && (
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="bg-white border-gray-300 text-gray-900 placeholder:text-gray-600 min-h-[80px] focus:ring-blue-500 transition-all duration-200"
                      />
                    </div>
                  )}
                </div>
