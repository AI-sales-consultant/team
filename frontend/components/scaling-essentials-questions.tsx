...
export function ScalingEssentialsQuestions({ answers, onAnswer, scrollToNextQuestion }: ScalingEssentialsQuestionsProps) {
  ...
  const handleOptionSelect = (questionId: string, option: string) => {
    ...
    if (currentIndex < scalingEssentialsQuestions.length - 1) {
      ...
      setTimeout(() => {
        ...
        scrollToNextQuestion(questionId, scalingEssentialsQuestions)
  ...
  return (
    <div className="space-y-6">
      {scalingEssentialsQuestions.map((question) => {
                  ...
                  {question.additionalInfo && (
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="bg-white border-gray-500 focus:ring-blue-500 transition-all duration-200"
                      />
                    </div>
                  )}
                </div>
